...
<body>
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          @if (Route::has('login'))
            @auth
        <li><a class="getstarted scrollto" href="{{ url('/all-tasks') }}">Home</a></li>
                @else
  ...
  <section id="hero" class="hero d-flex align-items-center">
    ...
    <div class="row mt-3">
      ...
      <strong>Attention!</strong> {{session('query')}}
  ...
  @endif
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          ...
          <h2 data-aos="fade-up" data-aos-delay="400">Complete tasks, earn cash!</h2>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row gx-0">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content">
              <h3>Who We Are</h3>
              <h2>Task-based websites have revolutionized the way we approach productivity and personal development.</h2>
              <p> These platforms provide users with a wide range of tasks to complete, offering a rewarding and engaging experience. Users are presented with various challenges, assignments, or projects that cater to their skills and interests.
Upon selecting a task, users embark on a journey of growth and accomplishment. Whether it's completing surveys, testing products, designing graphics, writing articles, or contributing to community initiatives, each task contributes to personal development and enhances valuable skills.</p>
              <div class="text-center text-lg-start">
            ...
            <div class="row gy-4">
              ...
              <div class="col-md-6">
                <div class="info-box">
                  ...
                  <h3>Open Hours</h3>
                  <p>Monday - Sunday<br>5:00AM - 05:00PM</p>
                </div>
              </div>
            </div>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Tasky</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">Sami Zafar</a>
      </div>
    </div>
  </footer><!-- End Footer -->
